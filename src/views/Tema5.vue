  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido(data-aos="flip-up")
      .titulo-principal__numero
        span 5
      h1 La asesoría comercial en el contexto de la política y normatividad
    ...
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-lg-10.col-12
        ...
        figure
          img.d-none.d-sm-none.d-md-block(src='@/assets/curso/temas/tema5/fig-3a.svg', alt='Se presentan las tareas del asesor comercial donde las más representativas son realizar acciones de cobranzas y recibir dinero en algunos casos y hacer constantemente la validación de los datos de los clientes.')  
    ...
    .row.justify-content-center.mb-5(data-aos="fade-down")
      .col-lg-10.col-12
        ...
        figure 
          img.d-none.d-sm-none.d-md-block(src='@/assets/curso/temas/tema5/fig-5a.svg', alt='Se presentan las cualidades del asesor comercial resumidas en capacidad personal de acción y comunicación, atención con seriedad y tacto, empatía con iniciativa clara y perseverancia mientras tiene voluntad de éxito y sentido de pertenencia con la empresa y con el logro.')  
          img.d-block.d-md-none(src='@/assets/curso/temas/tema5/fig-5b.svg', alt='Se presentan las cualidades del asesor comercial resumidas en capacidad personal de acción y comunicación, atención con seriedad y tacto, empatía con iniciativa clara y perseverancia mientras tiene voluntad de éxito y sentido de pertenencia con la empresa y con el logro.') 
